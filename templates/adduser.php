<?php
	...
	{
		$query="INSERT INTO admin (username ,lastname, gender, city, birth, email, pass) VALUES('$name','$lname','$gen','$city','$birth','$email','$pass')";
	...
	{
		$query="INSERT INTO parent (p_username ,p_lastname, p_gender, p_city, p_birth, p_email, p_pass) VALUES('$name','$lname','$gen','$city','$birth','$email','$pass')";
